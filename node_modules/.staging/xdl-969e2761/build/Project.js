...
let startWebpackServerAsync = (() => {
  var _ref46 = _asyncToGenerator(function* (projectRoot, options, verbose) {
    if (webpackDevServerInstance) {
      (_ProjectUtils || _load_ProjectUtils()).logError(projectRoot, 'expo', 'Webpack is already running.');
      return;
    }
    ...
    let config = (0, (_webpackConfig || _load_webpackConfig()).default)({ projectRoot, development: dev, production: !dev, https });
    ...
    yield new Promise(function (resolve, reject) {
      return webpackDevServerInstance.listen(webpackServerPort, '0.0.0.0', function (error) {
        if (error) {
          reject(error);
        } else {
          resolve();
  ...
  return function startWebpackServerAsync(_x84, _x85, _x86) {
...
let stopWebpackServerAsync = (() => {
  var _ref47 = _asyncToGenerator(function* (projectRoot) {
    ...
    if (devServer) {
      yield new Promise(function (resolve) {
        return devServer.close(function () {
          return resolve();
        });
      });
  ...
  return function stopWebpackServerAsync(_x87) {
...
let bundleWebpackAsync = exports.bundleWebpackAsync = (() => {
  ...
  return function bundleWebpackAsync(_x88, _x89) {
...
let _connectToNgrokAsync = (() => {
  ...
  return function _connectToNgrokAsync(_x92, _x93, _x94, _x95) {
...
let startTunnelsAsync = exports.startTunnelsAsync = (() => {
  ...
  return function startTunnelsAsync(_x96) {
...
let stopTunnelsAsync = exports.stopTunnelsAsync = (() => {
  ...
  return function stopTunnelsAsync(_x97) {
...
let setOptionsAsync = exports.setOptionsAsync = (() => {
  ...
  return function setOptionsAsync(_x98, _x99) {
...
let getUrlAsync = exports.getUrlAsync = (() => {
  ...
  return function getUrlAsync(_x100) {
...
let startAsync = exports.startAsync = (() => {
  var _ref59 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    ...
    yield startWebpackServerAsync(projectRoot, options, verbose);
  ...
  return function startAsync(_x101) {
...
let _stopInternalAsync = (() => {
  ...
  return function _stopInternalAsync(_x102) {
...
let stopAsync = exports.stopAsync = (() => {
  ...
  return function stopAsync(_x103) {
...
function getWebpackInstance(projectRoot) {
  if (webpackDevServerInstance == null) {
    (_ProjectUtils || _load_ProjectUtils()).logError(projectRoot, 'expo', 'Webpack is not running.');
  }
