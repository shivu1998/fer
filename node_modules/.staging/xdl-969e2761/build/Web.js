...
exports.onlySupportsWebAsync = exports.hasWebSupportAsync = exports.openProjectAsync = undefined;
...
let hasWebSupportAsync = exports.hasWebSupportAsync = (() => {
  ...
  return function hasWebSupportAsync(_x2) {
...
let onlySupportsWebAsync = exports.onlySupportsWebAsync = (() => {
  ...
  return function onlySupportsWebAsync(_x3) {
...
function logPreviewNotice() {
  console.log();
  console.log((_chalk || _load_chalk()).default.bold.yellow('Web support in Expo is experimental and subject to breaking changes. Do not use this in production yet.'));
  console.log();
}
...
function getWebSetupLogs() {
  ...
  ${(_chalk || _load_chalk()).default.green.bold(`+      "react-dom": "^16.7.0"`)}
    ...
    "devDependencies": {
  ${(_chalk || _load_chalk()).default.green.bold(`+      "babel-preset-expo": "^5.1.0"`)}
    }
  }`);
